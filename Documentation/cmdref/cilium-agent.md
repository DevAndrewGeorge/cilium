...
```
  ...
  -h, --help                                          help for cilium-agent
      ...
      --hubble-listen-addresses strings               List of addresses for Hubble server to listen to.
      --hubble-metrics strings                        List of Hubble metrics to enable.
      --hubble-metrics-server string                  Address to serve Hubble metrics on.
      --hubble-socket-path string                     Sets hubble's socket path to listen for connections (default "/var/run/cilium/hubble.sock")
